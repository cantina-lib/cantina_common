...
CANTINA_PHYSICS_NAMESPACE_BEGIN
    ...
    class RigidObject :
            public KineticObject<Len_T, Mass_T, Time_T, dim>,
    ...
    public:
        ...
        /** -- methods -- **/
        CANT_EXPLICIT RigidObject(UPtr<State> state, UPtr<Shape> shape);
        ...
        CANT_NODISCARD bool isStatic() const override { return false; }
