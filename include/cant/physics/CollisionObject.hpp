...
CANTINA_PHYSICS_NAMESPACE_BEGIN
    ...
    class CollisionObject :
            public PhysicalObjectTrait<PhysicalState<Len_T, dim>, Len_T, dim>,
    ...
    public:
        ...
        /** -- methods -- **/
        CANT_EXPLICIT CollisionObject(UPtr<State> state, UPtr<Shape> shape);
        ...
        CANT_NODISCARD Mass_T getInverseMass() const override { return static_cast<Mass_T>(0); }
        CANT_NODISCARD Velocity const& getVelocity() const override { return c_staticVelocity; }
        void setVelocity(Velocity) override { CANTINA_ASSERT(false, "should not try to call this method."); }
        CANT_NODISCARD Acceleration const& getAcceleration() const override { return c_staticAcceleration; }

        // Collidable
        WPtr<Collider> getCollider() const override;
        CANT_NODISCARD bool isStatic() const override { return true; }
