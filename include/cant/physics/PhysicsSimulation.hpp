...
CANTINA_PHYSICS_NAMESPACE_BEGIN
    ...
    public:
        ...
        void addRigidObject(ShPtr<DynamicObject>& rigidObject, typename Detector::LayerKey layer);
        void addKinematicObject(ShPtr<DynamicObject>& kinematicObject, typename Detector::LayerKey layer);
        void addStaticObject(ShPtr<StaticObject>& staticObject, typename Detector::LayerKey layer);

    private:
        /** -- methods -- **/
        void stepObjectsDelta(Time_T dt);
        void stepForceFieldsDelta(Time_T dt);
