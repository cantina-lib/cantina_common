...
CANTINA_PHYSICS_NAMESPACE_BEGIN
    ...
    public:
        ...
        virtual void setMass(Mass_T mass) = 0;
        CANT_NODISCARD virtual Mass_T getInverseMass() const = 0;

        virtual void setVelocity(Velocity velocity) = 0;
        CANT_NODISCARD virtual Velocity const& getVelocity() const = 0;

        CANT_NODISCARD virtual Acceleration const& getAcceleration() const = 0;
