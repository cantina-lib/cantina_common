...
BrokenLinesInterpolation<Ret_T, Param_Ts...>::BrokenLinesInterpolation(
  typename InterpolationOneD<Ret_T, Param_Ts...>::Values const & values)
    : InterpolationOneD(values)
{}

template <typename Ret_T, typename... Param_Ts>
Ret_T
  BrokenLinesInterpolation<Ret_T, Param_Ts...>::operator()(Tuple<Param_Ts> const &... args) const
{}

template <typename Ret_T, typename... Param_Ts>
CANT_NODISCARD Stream<typename BrokenLinesInterpolation<Ret_T, Param_Ts...>::Line>
               BrokenLinesInterpolation<Ret_T, Param_Ts...>::computeLines(
    Stream<typename InterpolationOneD<Ret_T, Param_Ts>::Value> const & values)
{
