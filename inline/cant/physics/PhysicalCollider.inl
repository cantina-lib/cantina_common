...
CANT_INLINE typename PhysicalCollider<Len_T, Mass_T, dim>::Vector
  PhysicalCollider<Len_T, Mass_T, dim>::getVectorToClosestRim(Position const & pos) const
{
...
template <typename Len_T, typename Mass_T, size_u dim>
CANT_INLINE typename PhysicalCollider<Len_T, Mass_T, dim>::Vector
  PhysicalCollider<Len_T, Mass_T, dim>::getVectorToCentre(Position const & pos) const
{
    // ditto.
...
template <typename Len_T, typename Mass_T, size_u dim>
CANT_INLINE typename PhysicalCollider<Len_T, Mass_T, dim>::Velocity const &
  PhysicalCollider<Len_T, Mass_T, dim>::getVelocity() const
{
...
template <typename Len_T, typename Mass_T, size_u dim>
CANT_INLINE Mass_T
  PhysicalCollider<Len_T, Mass_T, dim>::getInverseMass() const
{
    return m_owner->getInverseMass();
}

template <typename Len_T, typename Mass_T, size_u dim>
CANT_INLINE typename PhysicalCollider<Len_T, Mass_T, dim>::Position
  PhysicalCollider<Len_T, Mass_T, dim>::getCentre() const
{
...
template <typename Len_T, typename Mass_T, size_u dim>
CANT_INLINE void
  PhysicalCollider<Len_T, Mass_T, dim>::translate(Vector const & vec)
{
...
template <typename Len_T, typename Mass_T, size_u dim>
CANT_INLINE void
  PhysicalCollider<Len_T, Mass_T, dim>::setVelocity(Velocity velocity)
{
...
template <typename Len_T, typename Mass_T, size_u dim>
CANT_INLINE bool
  PhysicalCollider<Len_T, Mass_T, dim>::intersectsAABB(ShPtr<PhysicalCollider> const & other) const
{
...
template <typename Len_T, typename Mass_T, size_u dim>
CANT_INLINE bool
  PhysicalCollider<Len_T, Mass_T, dim>::intersects(ShPtr<PhysicalCollider> const & other) const
{
...
template <typename Len_T, typename Mass_T, size_u dim>
CANT_INLINE void
  PhysicalCollider<Len_T, Mass_T, dim>::setMass(Mass_T mass)
{
...
template <typename Len_T, typename Mass_T, size_u dim>
CANT_INLINE bool
  PhysicalCollider<Len_T, Mass_T, dim>::isStatic() const
{
    return m_owner->isStatic();
}

template <typename Len_T, typename Mass_T, size_u dim>
CANT_INLINE typename PhysicalCollider<Len_T, Mass_T, dim>::Acceleration const &
  PhysicalCollider<Len_T, Mass_T, dim>::getAcceleration() const
{
    return m_owner->getAcceleration();
}

template <typename Len_T, typename Mass_T, size_u dim>
PhysicalCollider<Len_T, Mass_T, dim>::PhysicalCollider(Collidable<Len_T, Mass_T, dim> * owner, UPtr<Shape> shape)
