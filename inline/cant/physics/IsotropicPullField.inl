...
typename IsotropicPullField<Len_T, Mass_T, Time_T, dim>::ForceField::DeltaForce
  IsotropicPullField<Len_T, Mass_T, Time_T, dim>::getDeltaForce(UPtr<typename DynamicObject::State> const & state) const
{
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
void
  IsotropicPullField<Len_T, Mass_T, Time_T, dim>::setSource(ShPtr<const SourceObject> & source)
{
    m_source = source;
}

template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
IsotropicPullField<Len_T, Mass_T, Time_T, dim>::IsotropicPullField(ForceDistanceFunctor      func,
                                                                   ShPtr<const SourceObject> source)
    : m_func(std::move(func)), m_source(source)
{}
