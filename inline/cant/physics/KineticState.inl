...
KineticState<Len_T, Mass_T, Time_T, dim>::KineticState(Mass_T mass, Position position)
    : PhysicalState<Len_T, dim>(std::move(position)), m_inverseMass(), m_velocity(), m_acceleration(), m_buffer()
{
    setMass(mass);
}

template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
KineticState<Len_T, Mass_T, Time_T, dim>::KineticState(Mass_T mass) : KineticState(mass, Position())
{}

template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
CANT_INLINE void
  KineticState<Len_T, Mass_T, Time_T, dim>::stepDelta(Time_T dt)
{
    /*
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
CANT_INLINE void
  KineticState<Len_T, Mass_T, Time_T, dim>::addDeltaForce(DeltaForce const & dF)
{
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
CANT_INLINE void
  KineticState<Len_T, Mass_T, Time_T, dim>::updateAccelerationFromAccumulatedForce()
{
    // Hypothesis:
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
CANT_INLINE void
  KineticState<Len_T, Mass_T, Time_T, dim>::updateVelocityFromAcceleration(Time_T dt)
{
    //         v(t + dt) = v(t) + dv(t)
    // with:     dv(t) = a(t) * dt
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
CANT_INLINE void
  KineticState<Len_T, Mass_T, Time_T, dim>::updatePositionFromVelocity(Time_T dt)
{
    // (p(t + dt) - p(t)) / dt = v(t)
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
CANT_INLINE void
  KineticState<Len_T, Mass_T, Time_T, dim>::clearAccumulatedDeltaForce()
{
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
void
  KineticState<Len_T, Mass_T, Time_T, dim>::setMass(Mass_T mass)
{
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
CANT_INLINE typename KineticState<Len_T, Mass_T, Time_T, dim>::Velocity const &
  KineticState<Len_T, Mass_T, Time_T, dim>::getVelocity() const
{
    return m_velocity;
}
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
CANT_INLINE void
  KineticState<Len_T, Mass_T, Time_T, dim>::setVelocity(KineticState::Velocity velocity)
{
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
Mass_T
  KineticState<Len_T, Mass_T, Time_T, dim>::getInverseMass() const
{
    return m_inverseMass;
}

template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
CANT_INLINE typename KineticState<Len_T, Mass_T, Time_T, dim>::Acceleration const &
  KineticState<Len_T, Mass_T, Time_T, dim>::getAcceleration() const
{
