...
PhysicsSimulation<Len_T, Mass_T, Time_T, dim>::PhysicsSimulation()
    : m_collisionDetector(), m_collisionSolver(), m_forceFields()
{}
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
void
  PhysicsSimulation<Len_T, Mass_T, Time_T, dim>::stepObjectsDelta(Time_T dt)
{
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
void
  PhysicsSimulation<Len_T, Mass_T, Time_T, dim>::stepForceFieldsDelta(Time_T dt)
{
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
void
  PhysicsSimulation<Len_T, Mass_T, Time_T, dim>::addForceField(UPtr<ForceField> forceField)
{
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
void
  PhysicsSimulation<Len_T, Mass_T, Time_T, dim>::addRigidObject(ShPtr<PhysicsSimulation::DynamicObject> & rigidObject,
...
void
  PhysicsSimulation<Len_T, Mass_T, Time_T, dim>::addKinematicObject(
    ShPtr<PhysicsSimulation::DynamicObject> & kinematicObject,
    typename Detector::LayerKey               layer)
{
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
void
  PhysicsSimulation<Len_T, Mass_T, Time_T, dim>::addStaticObject(ShPtr<PhysicsSimulation::StaticObject> & staticObject,
                                                                 typename Detector::LayerKey              layer)
{
