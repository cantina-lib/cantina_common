...
RigidObject<Len_T, Mass_T, Time_T, dim>::RigidObject(UPtr<State> state, UPtr<Shape> shape)
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
CANT_INLINE void
  RigidObject<Len_T, Mass_T, Time_T, dim>::setPosition(RigidObject::Position position)
{
    return KineticObject<Len_T, Mass_T, Time_T, dim>::setPosition(std::move(position));
}

template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
CANT_INLINE typename RigidObject<Len_T, Mass_T, Time_T, dim>::Position const &
  RigidObject<Len_T, Mass_T, Time_T, dim>::getPosition() const
{
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
CANT_INLINE void
  RigidObject<Len_T, Mass_T, Time_T, dim>::setMass(Mass_T mass)
{
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
CANT_INLINE Mass_T
  RigidObject<Len_T, Mass_T, Time_T, dim>::getInverseMass() const
{
    return KineticObject<Len_T, Mass_T, Time_T, dim>::getInverseMass();
}

template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
CANT_INLINE typename RigidObject<Len_T, Mass_T, Time_T, dim>::Velocity const &
  RigidObject<Len_T, Mass_T, Time_T, dim>::getVelocity() const
{
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
CANT_INLINE void
  RigidObject<Len_T, Mass_T, Time_T, dim>::setVelocity(RigidObject::Velocity velocity)
{
...
template <typename Len_T, typename Mass_T, typename Time_T, size_u dim>
CANT_INLINE typename RigidObject<Len_T, Mass_T, Time_T, dim>::Acceleration const &
  RigidObject<Len_T, Mass_T, Time_T, dim>::getAcceleration() const
{
