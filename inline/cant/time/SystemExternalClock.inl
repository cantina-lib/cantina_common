...
CANT_INLINE
SystemExternalClock::SystemExternalClock() : m_tStart(StdClock::now()), m_tAbsolute(), m_tLast()
{}

CANT_INLINE
void
  SystemExternalClock::updateTime()
{
    m_tLast     = m_tAbsolute;
...
CANT_INLINE
type_d
  SystemExternalClock::getCurrentTimeSeconds() const
{
...
CANT_INLINE
type_d
  SystemExternalClock::getDeltaTimeSeconds() const
{
