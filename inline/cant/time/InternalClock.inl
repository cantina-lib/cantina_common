...
CANT_INLINE
InternalClock::InternalClock(UPtr<ExternalClock> externalClock)
    : m_externalClock(std::move(externalClock)), m_tStartAbsoluteExternal(), m_tStartRunningExternal(),
      m_tStopRunningExternal(), m_tLastInternal(), m_tNotRunningTotal(), m_isRunning(false)
{
    reset();
}
...
CANT_INLINE
type_d
  InternalClock::getCurrentTimeSeconds() const
{
...
CANT_INLINE
type_d
  InternalClock::getDeltaTimeSeconds() const
{
...
CANT_INLINE
void
  InternalClock::setCustomTimeGetter(AbsoluteTimeGetter absoluteTimeGetter)
{
...
CANT_INLINE
UPtr<InternalClock>
  InternalClock::make(UPtr<ExternalClock> externalClock)
{
